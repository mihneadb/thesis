...
\lstset{breaklines=true,framextopmargin=0.5cm,frame=b}
...
\includegraphics[scale=0.4]{vu_logo.png}
\includegraphics[scale=0.4]{upb_logo.png}
...
\textit{``Testing can be used to show the presence of bugs, but never to show their absence!"}
...
{
\textbf{MTC} & \textbf{M}any \textbf{T}ask \textbf{C}omputing \\
\textbf{JSON} & \textbf{J}ava \textbf{S}cript \textbf{O}bject \textbf{N}otation \\
\textbf{MBps} & \textbf{M}ega \textbf{B}ytes \textbf{p}er \textbf{s}econd \\
\textbf{GBps} & \textbf{G}iga \textbf{B}ytes \textbf{p}er \textbf{s}econd \\
\textbf{RAM} & \textbf{R}andom \textbf{A}ccess \textbf{M}emory \\
\textbf{MPI} & \textbf{M}essage \textbf{P}assing \textbf{I}nterface \\
\textbf{I/O} & \textbf{I}nput \textbf{O}utput \\
\textbf{ANSI} & \textbf{A}merican \textbf{N}ational \textbf{S}tandards \textbf{I}nstitute \\
\textbf{API} & \textbf{A}pplication \textbf{P}rogramming \textbf{I}nterface \\
\textbf{POSIX} & \textbf{P}ortable \textbf{O}perating \textbf{S}ystem \textbf{I}nterface \\
